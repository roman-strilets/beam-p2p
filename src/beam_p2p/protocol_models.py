...
class ShieldedSignature:
    """Signature used in shielded TXO and Lelantus proofs."""
...
class SigmaConfigInfo:
    """Ring dimensions for a Sigma or Lelantus proof."""
...
@dataclass(frozen=True)
class TxCounts:
    """Transaction or block component counts."""
...
@dataclass(frozen=True)
class DecodedBlock:
    """Parsed Beam block returned by the Python Beam tooling."""
